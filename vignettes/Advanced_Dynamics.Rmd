...
To demonstrate the power of `CanonicalTockySeq` and `tradeSeq`, we will simulate a dataset with a true underlying biological structure:
* **Continuous Temporal Cascades:** 100 genes are mathematically engineered to peak sequentially along the developmental trajectory.
* **Condition Effects:** We simulate a biological knockout (KO) where cells have a 50% reduction in expressing the 'Late' stage genes compared to Wild-Type (WT).
