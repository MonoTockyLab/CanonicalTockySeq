...
* 100 genes are simulated to peak sequentially along the developmental trajectory.
* We simulate a biological knockout (KO) where cells have a 50% reduction in expressing the 'Late' stage genes compared to Wild-Type (WT).
